  ...
  return (
    <motion.div {...enter(0.15)} className="relative">
      ...
      <div className="glass relative aspect-[4/3] w-full overflow-hidden rounded-[28px] shadow-lg">
        ...
        {/* animated dashed match route (lost -> found) */}
        <svg
          viewBox="0 0 400 300"
        ...
        >
          ...
          <motion.path
            ...
            transition={reduced ? undefined : { duration: 1.8, repeat: Infinity, ease: "linear" }}
          />
        </svg>

        {/* floating location pins + AI sparkle */}
        <motion.div {...float(4.2)} className="absolute left-[10%] top-[12%] text-coral">
          <MapPin className="h-7 w-7" strokeWidth={2.2} aria-hidden="true" />
        </motion.div>
        <motion.div {...float(5, 0.8)} className="absolute bottom-[10%] right-[12%] text-teal">
          <MapPin className="h-6 w-6" strokeWidth={2.2} aria-hidden="true" />
        </motion.div>
        <motion.div {...float(4.6, 0.4)} className="absolute right-[22%] top-[30%] text-violet">
          <Sparkles className="h-5 w-5" aria-hidden="true" />
        </motion.div>

        {/* lost item card with tiny phone mock */}
              ...
              <div className="w-[190px] rounded-md border border-border-soft bg-surface p-3 shadow-lg">
                <div className="flex items-center gap-2.5">
                  ...
                  <div className="min-w-0">
                    ...
                    <p className="mt-1 truncate text-[13px] font-bold text-ink">iPhone 13 · Black</p>
                    <p className="truncate font-mono text-[10.5px] text-slate-light">Last seen: Library</p>
                  </div>
                </div>
              </div>
            </motion.div>
              ...
              <div className="w-[190px] rounded-md border border-border-soft bg-surface p-3 shadow-lg">
                <div className="flex items-center gap-2.5">
                  ...
                  <div className="min-w-0">
                    ...
                    <p className="mt-1 truncate text-[13px] font-bold text-ink">Phone near Cafe</p>
                    <p className="truncate font-mono text-[10.5px] text-slate-light">2h ago · Bldg C</p>
                  </div>
                </div>
              </div>
            </motion.div>
        ...
        {/* pulsing AI match chip at route midpoint */}
